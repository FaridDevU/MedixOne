...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const sidebarClasses = [
    'h-full w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col',
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className={sidebarClasses}>
        <div className="h-16 flex items-center justify-between px-4 bg-blue-600 border-b border-blue-700">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center flex-shrink-0">
              <span className="text-blue-600 font-bold text-lg">M</span>
            </div>
            <span className="text-white font-bold text-xl">MedixOne</span>
          </div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
          {menuItems.map((item) => {
            ...
            const iconClasses = ['mr-3', isActive ? 'text-blue-700' : 'text-gray-400'].join(' ')
        ...
        <div className="p-4 border-t border-gray-200">
          <div className="text-xs text-gray-500 text-center">© 2024 MedixOne</div>
        </div>
      </div>
    </div>
  )

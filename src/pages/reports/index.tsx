...
import { Search, Plus, BarChart3, FileText } from 'lucide-react'
    ...
    <Layout>
      <div className="p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Informes y estadísticas del sistema</p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="mt-1 text-sm text-gray-500">Genera el primer reporte del sistema.</p>
            </div>
          </CardContent>
        </Card>
      </div>
